...
При расчете курса проверяется соответствие:
```	
['iso'] == "EUR"
['code'] == 978 
['name'] == "евро"
...
<a target="_blank" href="https://jenkins.autotests.cloud/job/C02_OlgaKos_python_alfabank_api_test/8/allure/#suites">Пример</a>
